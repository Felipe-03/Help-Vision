...
<br>
   ...
   <div class="text-center"><h1>Cadastro <strong>Baixa Visão</strong></h1>
   </div>

<br>
 
 
    <label class="exampleFormControlSelect2 "><strong>O que você precisa mudar no seu dispositivo?</strong></label>
