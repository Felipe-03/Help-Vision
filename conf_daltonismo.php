...
<br>
   ...
   <div class="text-center"><h1>Configuração <strong>Daltonismo</strong></h1>
   </div>
...
<br>
	...
	<form action="verificaescolha.php" method="POST">
	
    <label class="exampleFormControlSelect2">Qual seu tipo de daltonismo?</label>
    <select name="escolha" multiple class="form-control text-center" id="exampleFormControlSelect2">
      <option>Acromático</option>
...
<br>
	 ...
	 <button type="submit" class="btn btn-primary mb-2" style="width:100%;"><h5>Cadastrar</h5></button>
